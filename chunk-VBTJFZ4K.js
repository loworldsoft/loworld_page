...
var LoadImage = (input, onLoad, onError, offlineProvider, mimeType = "", imageBitmapOptions) => {
  ...
  if (engine?._features.forceBitmapOverHTMLImageElement) {
    LoadFile(url, (data) => {
      engine.createImageBitmap(new Blob([data], { type: mimeType }), __spreadValues({ premultiplyAlpha: "none" }, imageBitmapOptions)).then((imgBmp) => {
        onLoad(imgBmp);
        if (usingObjectURL) {
...
//# sourceMappingURL=chunk-VBTJFZ4K.js.map
