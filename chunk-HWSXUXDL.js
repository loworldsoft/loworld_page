...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TableComponent, { className: "TableComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UploadDialogComponent, { className: "UploadDialogComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryManageTemplateComponent, { className: "CategoryManageTemplateComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryComponent, { className: "CategoryComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FileUploadDialogComponent, { className: "FileUploadDialogComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FileComponent, { className: "FileComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryManagePageComponent, { className: "CategoryManagePageComponent" });
})();
...
\u0275\u0275setComponentScope(CategoryComponent, [MatButton, NavigationComponent, MatTab, MatTabGroup, TreeviewComponent, MatSelectionList, MatListOption], []);
export {
  CategoryManageModule
};
//# sourceMappingURL=chunk-HWSXUXDL.js.map
