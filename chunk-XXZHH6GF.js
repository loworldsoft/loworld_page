...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FilmstripComponent, { className: "FilmstripComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WorkspaceComponent, { className: "WorkspaceComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditorPageComponent, { className: "EditorPageComponent" });
})();
...
//# sourceMappingURL=chunk-XXZHH6GF.js.map
