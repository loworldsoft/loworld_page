...
function line_default(x4, y4) {
  ...
  y4 = typeof y4 === "function" ? y4 : y4 === void 0 ? y : constant_default3(y4);
  function line(data) {
...
function area_default(x06, y06, y12) {
  var x12 = null, defined = constant_default3(true), context = null, curve = linear_default, output = null, path2 = withPath(area);
  ...
  y12 = typeof y12 === "function" ? y12 : y12 === void 0 ? y : constant_default3(+y12);
  function area(data) {
  ...
  area.x = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default3(+_), x12 = null, area) : x06;
  };
  area.x0 = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default3(+_), area) : x06;
  };
  area.x1 = function(_) {
    return arguments.length ? (x12 = _ == null ? null : typeof _ === "function" ? _ : constant_default3(+_), area) : x12;
  };
  area.y = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default3(+_), y12 = null, area) : y06;
  };
  area.y0 = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default3(+_), area) : y06;
  };
  area.y1 = function(_) {
...
function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
  var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D3 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt2(max2(0, r * r * d2 - D3 * D3)), cx0 = (D3 * dy - dx * d) / d2, cy0 = (-D3 * dx - dy * d) / d2, cx1 = (D3 * dy + dx * d) / d2, cy1 = (-D3 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
...
function pie_default() {
  var value = identity_default3, sortValues = descending_default, sort2 = null, startAngle = constant_default3(0), endAngle = constant_default3(tau2), padAngle = constant_default3(0);
  function pie(data) {
    var i, n = (data = array_default2(data)).length, j, k2, sum4 = 0, index3 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau2, Math.max(-tau2, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
...
function areaRadial_default() {
  var a4 = area_default().curve(curveRadialLinear), c6 = a4.curve, x06 = a4.lineX0, x12 = a4.lineX1, y06 = a4.lineY0, y12 = a4.lineY1;
...
function link(curve) {
  ...
  link3.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default3(+_), link3) : x4;
  };
  link3.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default3(+_), link3) : y4;
  };
...
var amplitude = 1;
var period = 0.3;
var elasticIn = function custom14(a4, p) {
  var s2 = Math.asin(1 / (a4 = Math.max(1, a4))) * (p /= tau3);
  function elasticIn2(t) {
    return a4 * tpmt(- --t) * Math.sin((s2 - t) / p);
  }
  elasticIn2.amplitude = function(a5) {
    return custom14(a5, p * tau3);
  };
  elasticIn2.period = function(p2) {
    return custom14(a4, p2);
  };
  return elasticIn2;
}(amplitude, period);
var elasticOut = function custom15(a4, p) {
  var s2 = Math.asin(1 / (a4 = Math.max(1, a4))) * (p /= tau3);
  function elasticOut2(t) {
    return 1 - a4 * tpmt(t = +t) * Math.sin((t + s2) / p);
  }
  elasticOut2.amplitude = function(a5) {
    return custom15(a5, p * tau3);
  };
  elasticOut2.period = function(p2) {
    return custom15(a4, p2);
  };
  return elasticOut2;
}(amplitude, period);
var elasticInOut = function custom16(a4, p) {
  var s2 = Math.asin(1 / (a4 = Math.max(1, a4))) * (p /= tau3);
  function elasticInOut2(t) {
    return ((t = t * 2 - 1) < 0 ? a4 * tpmt(-t) * Math.sin((s2 - t) / p) : 2 - a4 * tpmt(t) * Math.sin((s2 + t) / p)) / 2;
  }
  elasticInOut2.amplitude = function(a5) {
    return custom16(a5, p * tau3);
  };
...
function brush(dim) {
  ...
  function started(event) {
    ...
    function move(event2) {
      ...
      switch (mode2) {
        ...
        case MODE_DRAG: {
          if (signX)
            dx = max3(W - w0, min3(E2 - e0, dx)), w1 = w0 + dx, e1 = e0 + dx;
          if (signY)
            dy = max3(N - n0, min3(S - s0, dy)), n1 = n0 + dy, s1 = s0 + dy;
          break;
        }
        case MODE_HANDLE: {
          if (points[1]) {
            if (signX)
              w1 = max3(W, min3(E2, points[0][0])), e1 = max3(W, min3(E2, points[1][0])), signX = 1;
            if (signY)
              n1 = max3(N, min3(S, points[0][1])), s1 = max3(N, min3(S, points[1][1])), signY = 1;
          } else {
            if (signX < 0)
              dx = max3(W - w0, min3(E2 - w0, dx)), w1 = w0 + dx, e1 = e0;
            else if (signX > 0)
              dx = max3(W - e0, min3(E2 - e0, dx)), w1 = w0, e1 = e0 + dx;
            if (signY < 0)
              dy = max3(N - n0, min3(S - n0, dy)), n1 = n0 + dy, s1 = s0;
            else if (signY > 0)
              dy = max3(N - s0, min3(S - s0, dy)), n1 = n0, s1 = s0 + dy;
          }
          break;
        }
        case MODE_CENTER: {
          if (signX)
            w1 = max3(W, min3(E2, w0 - dx * signX)), e1 = max3(W, min3(E2, e0 + dx * signX));
          if (signY)
            n1 = max3(N, min3(S, n0 - dy * signY)), s1 = max3(N, min3(S, s0 + dy * signY));
          break;
        }
      }
      if (e1 < w1) {
  ...
  brush2.extent = function(_) {
    return arguments.length ? (extent2 = typeof _ === "function" ? _ : constant_default6(number22(_)), brush2) : extent2;
  };
  brush2.filter = function(_) {
    return arguments.length ? (filter3 = typeof _ === "function" ? _ : constant_default6(!!_), brush2) : filter3;
  };
  brush2.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default6(!!_), brush2) : touchable;
  };
...
function chord(directed, transpose2) {
  ...
  chord2.padAngle = function(_) {
    return arguments.length ? (padAngle = max4(0, _), chord2) : padAngle;
  };
...
function ribbon(headRadius) {
  ...
  function ribbon2() {
    var buffer, s2 = source.apply(this, arguments), t = target.apply(this, arguments), ap = padAngle.apply(this, arguments) / 2, argv = slice3.call(arguments), sr = +sourceRadius.apply(this, (argv[0] = s2, argv)), sa0 = startAngle.apply(this, argv) - halfPi3, sa1 = endAngle.apply(this, argv) - halfPi3, tr = +targetRadius.apply(this, (argv[0] = t, argv)), ta0 = startAngle.apply(this, argv) - halfPi3, ta1 = endAngle.apply(this, argv) - halfPi3;
    if (!context)
      context = buffer = path();
    if (ap > epsilon5) {
      if (abs3(sa1 - sa0) > ap * 2 + epsilon5)
        sa1 > sa0 ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
      else
        sa0 = sa1 = (sa0 + sa1) / 2;
      if (abs3(ta1 - ta0) > ap * 2 + epsilon5)
...
function contours_default() {
  ...
  contours.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default8(slice4.call(_)) : constant_default8(_), contours) : threshold2;
  };
...
function density_default() {
  var x4 = defaultX, y4 = defaultY, weight = defaultWeight, dx = 960, dy = 500, r = 20, k2 = 2, o = r * 3, n = dx + o * 2 >> k2, m3 = dy + o * 2 >> k2, threshold2 = constant_default8(20);
  function grid(data) {
  ...
  density.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default8(+_), density) : x4;
  };
  density.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default8(+_), density) : y4;
  };
  density.weight = function(_) {
    return arguments.length ? (weight = typeof _ === "function" ? _ : constant_default8(+_), density) : weight;
  };
  ...
  density.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default8(slice4.call(_)) : constant_default8(_), density) : threshold2;
  };
...
function link_default(links) {
  var id2 = index2, strength = defaultStrength, strengths, distance = constant_default9(30), distances, nodes, count3, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
...
function areaPointFirst(lambda, phi2) {
  ...
  lambda0 = lambda, cosPhi0 = cos3(phi2 = phi2 / 2 + quarterPi), sinPhi0 = sin3(phi2);
}
function areaPoint(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  phi2 = phi2 / 2 + quarterPi;
  var dLambda = lambda - lambda0, sdLambda = dLambda >= 0 ? 1 : -1, adLambda = sdLambda * dLambda, cosPhi = cos3(phi2), sinPhi = sin3(phi2), k2 = sinPhi0 * sinPhi, u4 = cosPhi0 * cosPhi + k2 * cos3(adLambda), v2 = k2 * sdLambda * sin3(adLambda);
...
function linePoint(lambda, phi2) {
  ...
  if (p0) {
    ...
    var delta = lambda - lambda2, sign3 = delta > 0 ? 1 : -1, lambdai = inflection[0] * degrees3 * sign3, phii, antimeridian = abs4(delta) > 180;
...
function boundsRingPoint(lambda, phi2) {
  if (p0) {
    ...
    deltaSum.add(abs4(delta) > 180 ? delta + (delta > 0 ? 360 : -360) : delta);
  } else {
...
function centroidPoint(lambda, phi2) {
  ...
  centroidPointCartesian(cosPhi * cos3(lambda), cosPhi * sin3(lambda), sin3(phi2));
}
...
function centroidLinePointFirst(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  var cosPhi = cos3(phi2);
  x0 = cosPhi * cos3(lambda);
  y0 = cosPhi * sin3(lambda);
  z0 = sin3(phi2);
...
function centroidLinePoint(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  var cosPhi = cos3(phi2), x4 = cosPhi * cos3(lambda), y4 = cosPhi * sin3(lambda), z = sin3(phi2), w = atan22(sqrt4((w = y0 * z - z0 * y4) * w + (w = z0 * x4 - x0 * z) * w + (w = x0 * y4 - y0 * x4) * w), x0 * x4 + y0 * y4 + z0 * z);
  W1 += w;
  X1 += w * (x0 + (x0 = x4));
  Y1 += w * (y0 + (y0 = y4));
  Z1 += w * (z0 + (z0 = z));
...
function centroidRingPoint(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  var cosPhi = cos3(phi2), x4 = cosPhi * cos3(lambda), y4 = cosPhi * sin3(lambda), z = sin3(phi2), cx = y0 * z - z0 * y4, cy = z0 * x4 - x0 * z, cz = x0 * y4 - y0 * x4, m3 = hypot(cx, cy, cz), w = asin2(m3), v2 = m3 && -w / m3;
  X2.add(v2 * cx);
  Y2.add(v2 * cy);
  Z2.add(v2 * cz);
  W1 += w;
...
function rotationPhiGamma(deltaPhi, deltaGamma) {
  ...
  function rotation(lambda, phi2) {
    var cosPhi = cos3(phi2), x4 = cos3(lambda) * cosPhi, y4 = sin3(lambda) * cosPhi, z = sin3(phi2), k2 = z * cosDeltaPhi + x4 * sinDeltaPhi;
    return [
  ...
  rotation.invert = function(lambda, phi2) {
    var cosPhi = cos3(phi2), x4 = cos3(lambda) * cosPhi, y4 = sin3(lambda) * cosPhi, z = sin3(phi2), k2 = z * cosDeltaGamma - y4 * sinDeltaGamma;
    return [
...
function circleStream(stream, radius, delta, direction, t03, t13) {
  ...
  for (var point6, t = t03; direction > 0 ? t > t13 : t < t13; t -= step) {
    point6 = spherical([cosRadius, -sinRadius * cos3(t), -sinRadius * sin3(t)]);
...
function circleRadius(cosRadius, point6) {
  ...
  return ((-point6[2] < 0 ? -radius : radius) + tau6 - epsilon8) % tau6;
}
...
function pointEqual_default(a4, b) {
  return abs4(a4[0] - b[0]) < epsilon8 && abs4(a4[1] - b[1]) < epsilon8;
}
...
function polygonContains_default(polygon, point6) {
  var lambda = longitude(point6), phi2 = point6[1], sinPhi = sin3(phi2), normal = [sin3(lambda), -cos3(lambda), 0], angle2 = 0, winding = 0;
  var sum4 = new Adder();
  if (sinPhi === 1)
    phi2 = halfPi4 + epsilon8;
  else if (sinPhi === -1)
    phi2 = -halfPi4 - epsilon8;
  for (var i = 0, n = polygon.length; i < n; ++i) {
    if (!(m3 = (ring = polygon[i]).length))
      continue;
    var ring, m3, point0 = ring[m3 - 1], lambda04 = longitude(point0), phi02 = point0[1] / 2 + quarterPi, sinPhi03 = sin3(phi02), cosPhi03 = cos3(phi02);
    for (var j = 0; j < m3; ++j, lambda04 = lambda12, sinPhi03 = sinPhi1, cosPhi03 = cosPhi1, point0 = point1) {
      var point1 = ring[j], lambda12 = longitude(point1), phi12 = point1[1] / 2 + quarterPi, sinPhi1 = sin3(phi12), cosPhi1 = cos3(phi12), delta = lambda12 - lambda04, sign3 = delta >= 0 ? 1 : -1, absDelta = sign3 * delta, antimeridian = absDelta > pi5, k2 = sinPhi03 * sinPhi1;
      sum4.add(atan22(k2 * sign3 * sin3(absDelta), cosPhi03 * cosPhi1 + k2 * cos3(absDelta)));
  ...
  return (angle2 < -epsilon8 || angle2 < epsilon8 && sum4 < -epsilon22) ^ winding & 1;
}
...
function compareIntersection(a4, b) {
  return ((a4 = a4.x)[0] < 0 ? a4[1] - halfPi4 - epsilon8 : halfPi4 - a4[1]) - ((b = b.x)[0] < 0 ? b[1] - halfPi4 - epsilon8 : halfPi4 - b[1]);
}
...
function clipAntimeridianLine(stream) {
  ...
  return {
    ...
    point: function(lambda12, phi12) {
      var sign1 = lambda12 > 0 ? pi5 : -pi5, delta = abs4(lambda12 - lambda04);
      if (abs4(delta - pi5) < epsilon8) {
        ...
        if (abs4(lambda04 - sign0) < epsilon8)
          lambda04 -= sign0 * epsilon8;
        if (abs4(lambda12 - sign1) < epsilon8)
...
function clipAntimeridianIntersect(lambda04, phi02, lambda12, phi12) {
  var cosPhi03, cosPhi1, sinLambda0Lambda1 = sin3(lambda04 - lambda12);
  return abs4(sinLambda0Lambda1) > epsilon8 ? atan((sin3(phi02) * (cosPhi1 = cos3(phi12)) * sin3(lambda12) - sin3(phi12) * (cosPhi03 = cos3(phi02)) * sin3(lambda04)) / (cosPhi03 * cosPhi1 * sinLambda0Lambda1)) : (phi02 + phi12) / 2;
}
function clipAntimeridianInterpolate(from, to, direction, stream) {
  ...
  if (from == null) {
    ...
    stream.point(-pi5, 0);
    stream.point(-pi5, phi2);
  } else if (abs4(from[0] - to[0]) > epsilon8) {
...
function circle_default3(radius) {
  var cr = cos3(radius), delta = 2 * radians2, smallRadius = cr > 0, notHemisphere = abs4(cr) > epsilon8;
  ...
  function intersect2(a4, b, two) {
    ...
    var delta2 = lambda12 - lambda04, polar = abs4(delta2 - pi5) < epsilon8, meridian = polar || delta2 < epsilon8;
    if (!polar && phi12 < phi02)
      z = phi02, phi02 = phi12, phi12 = z;
    if (meridian ? polar ? phi02 + phi12 > 0 ^ q[1] < (abs4(q[0] - lambda04) < epsilon8 ? phi02 : phi12) : phi02 <= q[1] && q[1] <= phi12 : delta2 > pi5 ^ (lambda04 <= q[0] && q[0] <= lambda12)) {
...
function clipRectangle(x06, y06, x12, y12) {
  ...
  function corner(p, direction) {
    return abs4(p[0] - x06) < epsilon8 ? direction > 0 ? 0 : 3 : abs4(p[0] - x12) < epsilon8 ? direction > 0 ? 2 : 1 : abs4(p[1] - y06) < epsilon8 ? direction > 0 ? 1 : 0 : direction > 0 ? 3 : 2;
  }
...
function lengthPointFirst(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  lambda03 = lambda, sinPhi02 = sin3(phi2), cosPhi02 = cos3(phi2);
  lengthStream.point = lengthPoint;
}
function lengthPoint(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  var sinPhi = sin3(phi2), cosPhi = cos3(phi2), delta = abs4(lambda - lambda03), cosDelta = cos3(delta), sinDelta = sin3(delta), x4 = cosPhi * sinDelta, y4 = cosPhi02 * sinPhi - sinPhi02 * cosPhi * cosDelta, z = sinPhi02 * sinPhi + cosPhi02 * cosPhi * cosDelta;
...
function graticuleX(y06, y12, dy) {
  var y4 = range(y06, y12 - epsilon8, dy).concat(y12);
  return function(x4) {
...
function graticuleY(x06, x12, dx) {
  var x4 = range(x06, x12 - epsilon8, dx).concat(x12);
  return function(y4) {
...
function interpolate_default2(a4, b) {
  var x06 = a4[0] * radians2, y06 = a4[1] * radians2, x12 = b[0] * radians2, y12 = b[1] * radians2, cy0 = cos3(y06), sy0 = sin3(y06), cy1 = cos3(y12), sy1 = sin3(y12), kx0 = cy0 * cos3(x06), ky0 = cy0 * sin3(x06), kx1 = cy1 * cos3(x12), ky1 = cy1 * sin3(x12), d = 2 * asin2(sqrt4(haversin(y12 - y06) + cy0 * cy1 * haversin(x12 - x06))), k2 = sin3(d);
  var interpolate = d ? function(t) {
    var B3 = sin3(t *= d) / k2, A5 = sin3(d - t) / k2, x4 = A5 * kx0 + B3 * kx1, y4 = A5 * ky0 + B3 * ky1, z = A5 * sy0 + B3 * sy1;
    return [
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b02, c0, x12, y12, lambda12, a1, b12, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b02 + b12, c6 = c0 + c1, m3 = sqrt4(a4 * a4 + b * b + c6 * c6), phi2 = asin2(c6 /= m3), lambda22 = abs4(abs4(c6) - 1) < epsilon8 || abs4(lambda04 - lambda12) < epsilon8 ? (lambda04 + lambda12) / 2 : atan22(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function scaleTranslateRotate(k2, dx, dy, sx, sy, alpha) {
  ...
  var cosAlpha = cos3(alpha), sinAlpha = sin3(alpha), a4 = cosAlpha * k2, b = sinAlpha * k2, ai = cosAlpha / k2, bi = sinAlpha / k2, ci = (sinAlpha * dy - cosAlpha * dx) / k2, fi = (sinAlpha * dx + cosAlpha * dy) / k2;
  function transform2(x4, y4) {
    x4 *= sx;
    y4 *= sy;
...
function cylindricalEqualAreaRaw(phi02) {
  var cosPhi03 = cos3(phi02);
  function forward(lambda, phi2) {
    return [lambda * cosPhi03, sin3(phi2) / cosPhi03];
  }
...
function conicEqualAreaRaw(y06, y12) {
  var sy0 = sin3(y06), n = (sy0 + sin3(y12)) / 2;
  if (abs4(n) < epsilon8)
    return cylindricalEqualAreaRaw(y06);
  var c6 = 1 + sy0 * (2 * n - sy0), r0 = sqrt4(c6) / n;
  function project(x4, y4) {
    var r = sqrt4(c6 - 2 * n * sin3(y4)) / n;
    return [r * sin3(x4 *= n), r0 - r * cos3(x4)];
  }
  project.invert = function(x4, y4) {
    var r0y = r0 - y4, l = atan22(x4, abs4(r0y)) * sign2(r0y);
    if (r0y * n < 0)
      l -= pi5 * sign2(x4) * sign2(r0y);
    return [l / n, asin2((c6 - (x4 * x4 + r0y * r0y) * n * n) / (2 * n))];
  };
  return project;
}
...
function albersUsa_default() {
  ...
  albersUsa.translate = function(_) {
    ...
    alaskaPoint = alaska.translate([x4 - 0.307 * k2, y4 + 0.201 * k2]).clipExtent([[x4 - 0.425 * k2 + epsilon8, y4 + 0.12 * k2 + epsilon8], [x4 - 0.214 * k2 - epsilon8, y4 + 0.234 * k2 - epsilon8]]).stream(pointStream);
    hawaiiPoint = hawaii.translate([x4 - 0.205 * k2, y4 + 0.212 * k2]).clipExtent([[x4 - 0.214 * k2 + epsilon8, y4 + 0.166 * k2 + epsilon8], [x4 - 0.115 * k2 - epsilon8, y4 + 0.234 * k2 - epsilon8]]).stream(pointStream);
    return reset();
  };
...
function azimuthalRaw(scale2) {
  return function(x4, y4) {
    var cx = cos3(x4), cy = cos3(y4), k2 = scale2(cx * cy);
    if (k2 === Infinity)
      return [2, 0];
    return [
      k2 * cy * sin3(x4),
...
function azimuthalInvert(angle2) {
  return function(x4, y4) {
    var z = sqrt4(x4 * x4 + y4 * y4), c6 = angle2(z), sc = sin3(c6), cc2 = cos3(c6);
    return [
      atan22(x4 * sc, z * cc2),
      asin2(z && y4 * sc / z)
    ];
...
function conicConformalRaw(y06, y12) {
  var cy0 = cos3(y06), n = y06 === y12 ? sin3(y06) : log2(cy0 / cos3(y12)) / log2(tany(y12) / tany(y06)), f = cy0 * pow3(tany(y06), n) / n;
  if (!n)
    return mercatorRaw;
  function project(x4, y4) {
    if (f > 0) {
      if (y4 < -halfPi4 + epsilon8)
        y4 = -halfPi4 + epsilon8;
    } else {
      if (y4 > halfPi4 - epsilon8)
        y4 = halfPi4 - epsilon8;
    ...
    return [r * sin3(n * x4), f - r * cos3(n * x4)];
  }
  project.invert = function(x4, y4) {
    var fy = f - y4, r = sign2(n) * sqrt4(x4 * x4 + fy * fy), l = atan22(x4, abs4(fy)) * sign2(fy);
    if (fy * n < 0)
      l -= pi5 * sign2(x4) * sign2(fy);
    return [l / n, 2 * atan(pow3(f / r, 1 / n)) - halfPi4];
  };
  return project;
}
...
function conicEquidistantRaw(y06, y12) {
  var cy0 = cos3(y06), n = y06 === y12 ? sin3(y06) : (cy0 - cos3(y12)) / (y12 - y06), g = cy0 / n + y06;
  if (abs4(n) < epsilon8)
  ...
  project.invert = function(x4, y4) {
    var gy = g - y4, l = atan22(x4, abs4(gy)) * sign2(gy);
    if (gy * n < 0)
      l -= pi5 * sign2(x4) * sign2(gy);
...
function gnomonicRaw(x4, y4) {
  var cy = cos3(y4), k2 = cos3(x4) * cy;
  return [cy * sin3(x4) / k2, sin3(y4) / k2];
}
...
function identity_default5() {
  var k2 = 1, tx = 0, ty = 0, sx = 1, sy = 1, alpha = 0, ca3, sa, x06 = null, y06, x12, y12, kx2 = 1, ky2 = 1, transform2 = transformer4({
    point: function(x4, y4) {
  ...
  projection2.angle = function(_) {
    return arguments.length ? (alpha = _ % 360 * radians2, sa = sin3(alpha), ca3 = cos3(alpha), reset()) : alpha * degrees3;
  };
  projection2.reflectX = function(_) {
...
function orthographicRaw(x4, y4) {
  return [cos3(y4) * sin3(x4), sin3(y4)];
}
...
function stereographicRaw(x4, y4) {
  var cy = cos3(y4), k2 = 1 + cos3(x4) * cy;
  return [cy * sin3(x4) / k2, sin3(y4) / k2];
}
...
function cross_default2(a4, b, c6) {
...
function sinebow_default(t) {
  var x4;
  t = (0.5 - t) * Math.PI;
  c5.r = 255 * (x4 = Math.sin(t)) * x4;
  c5.g = 255 * (x4 = Math.sin(t + pi_1_3)) * x4;
  c5.b = 255 * (x4 = Math.sin(t + pi_2_3)) * x4;
  return c5 + "";
}
...
//# sourceMappingURL=chunk-3L3N7GPT.js.map
